...
class FocusGame:
    ...
    def __init__(self, player_tuple_1, player_tuple_2):
        ...
        self._current_turn = 0      # May have a value of 1 or 2

        self._board = [[], [], [], [], [], []]
        self._board[0] = [[self._player_1.get_player_color()], [self._player_1.get_player_color()], [self._player_2.get_player_color()],
                          [self._player_2.get_player_color()], [self._player_1.get_player_color()], [self._player_1.get_player_color()]]
        self._board[1] = [[self._player_2.get_player_color()], [self._player_2.get_player_color()], [self._player_1.get_player_color()],
                          [self._player_1.get_player_color()], [self._player_2.get_player_color()], [self._player_2.get_player_color()]]
        self._board[2] = [[self._player_1.get_player_color()], [self._player_1.get_player_color()], [self._player_2.get_player_color()],
                          [self._player_2.get_player_color()], [self._player_1.get_player_color()], [self._player_1.get_player_color()]]
        self._board[3] = [[self._player_2.get_player_color()], [self._player_2.get_player_color()], [self._player_1.get_player_color()],
                          [self._player_1.get_player_color()], [self._player_2.get_player_color()], [self._player_2.get_player_color()]]
        self._board[4] = [[self._player_1.get_player_color()], [self._player_1.get_player_color()], [self._player_2.get_player_color()],
                          [self._player_2.get_player_color()], [self._player_1.get_player_color()], [self._player_1.get_player_color()]]
        self._board[5] = [[self._player_2.get_player_color()], [self._player_2.get_player_color()], [self._player_1.get_player_color()],
                          [self._player_1.get_player_color()], [self._player_2.get_player_color()], [self._player_2.get_player_color()]]
    ...
    def get_other_player(self, player):
        """Gets the other player from the one entered"""
    ...
    def greater_than_five(self, location, size, player):
        """Adds the bottom pieces to the reserve or captured of the moving player"""
    ...
    def move_piece(self, player_name, start_coord, end_coord, num_pieces):
        ...
        top_start = start_pieces[len(start_pieces) - 1]
        ...
        if num_pieces > 1:
            ...
            self.get_board()[end_coord[0]][end_coord[1]] += move_pieces
            for x in range(len(move_pieces)):
                self.get_board()[start_coord[0]][start_coord[1]].pop()
        else:
            self.get_board()[end_coord[0]][end_coord[1]].append(start_pieces[0])
            self.get_board()[start_coord[0]][start_coord[1]].pop()

        end_location = self.get_board()[end_coord[0]][end_coord[1]]

        end_coord_size = len(self.get_board()[end_coord[0]][end_coord[1]])
...
# # print(fg.show_reserve("Mitch"))
# print(fg.move_piece("Mitch", (0,0), (1,0), 1))
# # fg.print_board()
